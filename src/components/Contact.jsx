    ...
    <section id="contact" className="py-24 bg-base relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        <div className="max-w-6xl mx-auto" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-[#1e1e2e] rounded-[2.5rem] p-1 border border-white/5 shadow-2xl">
            <div className="bg-[#11111b] rounded-[2.4rem] overflow-hidden flex flex-col md:flex-row">
