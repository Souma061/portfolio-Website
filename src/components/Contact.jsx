  ...
  return (
    <section id="contact" className="py-24 bg-base relative overflow-hidden" data-aos="fade-up">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        {/* Unified Solid Panel with Skills-like Double Layer */}
        <div className="max-w-6xl mx-auto" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-base rounded-[2.5rem] p-1 border border-white/5 shadow-2xl">
            <div className="bg-crust rounded-[2.4rem] overflow-hidden flex flex-col md:flex-row">

              {/* Left Side: Contact Info & Decor */}
              <div className="md:w-5/12 p-10 flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-white/5">

                {/* Overlay Patterns */}
                <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top_right,var(--tw-gradient-stops))] from-surface0 via-transparent to-transparent" />
                ...
                <div className="relative z-10 mt-10 md:mt-0">
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      { Icon: Github, href: "https://github.com/Souma061", color: "hover:bg-surface1 hover:border-surface1" },
                      { Icon: Twitter, href: "https://x.com/SoumabrataGhosh", color: "hover:bg-surface2 hover:border-surface2" }
                    ].map((social, index) => {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="relative group">
                      <input
                        ...
                        className="peer w-full bg-transparent border-b-2 border-gray-700 py-3 px-1 text-main placeholder-transparent focus:outline-none focus:border-purple transition-colors"
                        placeholder="Name"
                        id="contact-name"
                        required
                      />
                    ...
                    <div className="relative group">
                      <input
                        ...
                        onChange={handleChange}
                        className="peer w-full bg-transparent border-b-2 border-gray-700 py-3 px-1 text-main placeholder-transparent focus:outline-none focus:border-cyan transition-colors"
                        placeholder="Email"
                        id="contact-email"
                        required
                      />
                  ...
                  <div className="relative group">
                    <input
                      ...
                      onChange={handleChange}
                      className="peer w-full bg-transparent border-b-2 border-gray-700 py-3 px-1 text-main placeholder-transparent focus:outline-none focus:border-pink transition-colors"
                      placeholder="Subject"
                      id="contact-subject"
                      required
                    />
